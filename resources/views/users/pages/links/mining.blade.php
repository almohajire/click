...
@section('content')
    ...
    @if($poping)
        ...
        <div class="alert alert-success">
            <strong>Greate you have now a gift for point booster link : </strong> <a href="{{ route('links.surf2', $poping->link->id) }}" class="btn btn-lg bg-{{ \App\Helpers\Common\Holder::template_colors(  array_rand( \App\Helpers\Common\Holder::template_colors() ,1 )  )['slug'] }} pull-right">Click</a>.
            <br />
